  ...
  return (
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl ">
        ...
        <div className="flex items-center space-x-5 flex-1 justify-center  md:justify-end w-full">
          <form className="flex items-center md:space-x-5 bg-white rounded-md p-2 shadow-md flex-1 md:flex-initial">
          ...
          <Avatar name="Rohit Verma" round size="50" color="#0055D1" />
        </div>
      </div>
